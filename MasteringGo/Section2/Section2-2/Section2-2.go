...
func main() {
	...
	var v2 = 2 // declare and assign a variable (variable with initializers)
	...
	// function pass by value, so we need the argument to be pointer if we want to change the value of the passed variable
	X := 5
	ChangeX(&X)
	...
	computeMultiplyVal := func(val int, fn func(a, b int) int) int {
